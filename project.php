...
<nav class="property-nav">
    ...
    <a href="<?= BASE_URL ?>/project?slug=<?= e($adjacent['prev']['slug']) ?>" class="property-nav-item">
    ...
    <a href="<?= BASE_URL ?>/project?slug=<?= e($adjacent['next']['slug']) ?>" class="property-nav-item property-nav-item--next">
